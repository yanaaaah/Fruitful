            ...
            NavigationStack {
                ScrollView {
                    VStack {
                        ...
                        EditGoalsBubblesView(title: "🍏 Sleep", value: $sleep, colour: .sleepColour, alertTitle: "Sleep Information", alertMessage: "Sleep is cruicial for enhacing overall well-being and cognitive function with most people needing 7-9 hours.", alertButtonText: "Done" )
                        EditGoalsBubblesView(title: "🫐 Movement", value: $movement, colour: .movementColour, alertTitle: "Movement Information", alertMessage: "Physical movement is important for overall health and well-being and recommended 30mins a day.", alertButtonText: "Done" )
                        EditGoalsBubblesView(title: "🍋 Social", value: $social, colour: .socialColour, alertTitle: "Social Information", alertMessage: "Regular social connection is important to combat loneliness and foster emtional wellbeing. This can incude seeing friends and family.", alertButtonText: "Done" )
                        EditGoalsBubblesView(title: "🍊 Personal", value: $personal, colour: .personalColour, alertTitle: "Personal Information", alertMessage: "This includes time dedicated  to hobbies, running errands, attending appointments or engaging in activities that contribute to your personal wellbeing.", alertButtonText: "Done" )
                        EditGoalsBubblesView(title: "🥭 Downtime", value: $downtime, colour: .downtimeColour, alertTitle: "Downtime Information", alertMessage: "This is time spent doing nothing in particular, like scrolling on your phone or simply lying in bed. Rest is essential, so don’t feel guilty as your mind and body need it.", alertButtonText: "Done" )
                        VStack{
                            HStack{
